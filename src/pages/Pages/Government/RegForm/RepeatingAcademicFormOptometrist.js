...
const RepeatingAcademicFormOptometrist = ({ academic_form, addAcademic, academic_index, name_academic, setName_academic, from_academic, setFrom_academic,
    to_academic, setTo_academic, grade_academic, setGrade_academic, switchAcademicBtn, setSwitchAcademicBtn, academic_id, userId, count, setCount, refreshUpdate,oneOptometrist
}) => {
            ...
            <Form>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    {switchAcademicBtn === true ? <div>
                        <button type="button" className="btn mx-2 bg-danger text-white" disabled={read_only_optometrist} onClick={() => cancelAcademicUpdate()}> Cancel</button>
                        <button type="button" className="btn" style={{ background: ' rgb(0, 58, 3)', color: '#fff', borderColor: '1px solid rgb(0,58,3)' }} disabled={read_only_optometrist} onClick={() => updateAcademic()}> Update</button>
                    </div> :
                        <>{oneOptometrist !== null ?
                            <button type="button" className="btn mx-2" style={{ background: ' rgb(0, 58, 3)', color: '#fff', borderColor: '1px solid rgb(0,58,3)' }} disabled={read_only_optometrist} onClick={() => newAcademicHttp()}> Add </button>
                            : <button type="button" className="btn mx-2" style={{ background: ' rgb(0, 58, 3)', color: '#fff', borderColor: '1px solid rgb(0,58,3)' }} disabled={read_only_optometrist} onClick={() => newAcademic()}> Add </button>
                        }</>
                    }
                ...
                <Row className='justify-content-between align-items-center'>
                    ...
                    <Col md={6} className='mb-md-0 mt-3'>
                        ...
                        {/* <Input type='text' id={`item-name-${1}`}
                            value={from_academic} onChange={(e) => setFrom_academic(e.target.value)}
                            placeholder='From' /> */}
                    ...
                    <Col md={6} className='mb-md-0 mt-3'>
                        ...
                        {/* <Input type='text' id={`item-name-${1}`}
                            value={to_academic} onChange={(e) => setTo_academic(e.target.value)}
                            placeholder='To' /> */}
                    </Col>
                    {/* <hr /> */}
                </Row>
...
export default RepeatingAcademicFormOptometrist
