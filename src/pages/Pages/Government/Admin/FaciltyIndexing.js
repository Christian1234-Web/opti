...
const FacilityIndexing = () => {
    ...
    const approveOrDisapprove = async type => {
        ...
        const data = { practiceId: idDetails?.id, note: comment };
        try {
            setLoading(true);
            const url = `practices/${type}?role=${user.type.trim()}&senderid=${user.id}`;
                                ...
                                <Row className="g-3">
                                    ...
                                    <Col lg={3} xs={6}>
                                        ...
                                        {idDetails === null ? <span className="badge badge-soft-danger fs-11">--</span> :
                                            <>
                                                {type.type === 'practice' ? idDetails?.isApprovedBySD === true ? <span className="badge badge-soft-success fs-11">Approved</span> :
                                    ...
                                    <Col lg={3} xs={6}>
                                        ...
                                        {idDetails === null ? <span className="badge badge-soft-danger fs-11">--</span> :
                                            <>
                                                {type.type === 'practice' ? idDetails?.isApprovedByHOD === true ? <span className="badge badge-soft-success fs-11">Approved</span> :
                                        ...
                                        {idDetails === null ? <span className="badge badge-soft-danger fs-11">No</span> :
                                            <>
                                                {type.type === 'practice' ? idDetails?.isApprovedByAdmin === true ? <span className="badge badge-soft-success fs-11">Approved</span> :
                                                    idDetails?.isApprovedByHOD === null ? <span className="badge badge-soft-primary fs-11">Awaiting Approval</span> :
                                                        <span className="badge badge-soft-danger fs-11">Disapproved</span> : ""
                                                }
                                            </>
