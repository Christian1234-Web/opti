...
import { Col, NavItem, NavLink, Offcanvas, OffcanvasBody, Row, UncontrolledCollapse } from 'reactstrap';
                        ...
                        <ul className="message-list">
                            ...
                            <li className='unread'>
                                <div className="col-mail col-mail-1">
                                    ...
                                    <Link to="#" className="title text-capitalize">{new Date(messages?.indexing?.createdAt).toDateString()}</Link>
                                </div>
                                <div className="col-mail col-mail-2" onClick={() => showMessage(messages.indexing)}>
                                    <Link to="#" className="subject text-capitalize"> {<span className={"badge me-2 bg-"}></span>} <span className="teaser text-capitalize">{`Indexing`} Id:{messages?.indexing?.id}</span>
                                    </Link>
                                    <div className="date">{new Date(messages?.indexing?.createdAt).toLocaleDateString()}</div>
                                </div>
                            </li>
                        </ul>
                    </SimpleBar>
